...
class AppTheme {
  static TextTheme _createTextTheme(BuildContext context, String bodyFontString, String displayFontString) {
  ...
  static ColorScheme get lightScheme {
    return const ColorScheme(
      ...
      surfaceTint: Color.fromARGB(255, 23, 28, 37),
  ...
  static ThemeData get lightTheme {
    final textTheme = GoogleFonts.adaminaTextTheme();
    return ThemeData(
      useMaterial3: true,
      brightness: Brightness.light,
